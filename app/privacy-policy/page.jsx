      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16">
        ...
        <div className="mt-8 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600">
              You may not create a link to our website from another website or document without MANISHA GAJANAN PATIL’s prior written consent.
            </p>
            ...
            <p className="text-lg text-gray-700">
            <strong>No cancellations & Refunds are entertained</strong>
          </p>
          <p className="text-lg text-gray-700">
            <strong>Shipping is not applicable for business.</strong>
          </p>
          </div>
        </div>
      </div>
